...
@section('contenido')
	@if(count($docentes)==0)
		<div class="container-fluid">
			...
			<a class="btn btn-light bg-warning" href="{{route('registrardocente')}}">Agregar docente</a>
		    </div>
		</div>
	@else
		<div class="container-fluid">
						  ...
						  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						    <div class="modal-content bg-dark">
						      <div class="modal-header">
						        <h5 class="modal-title text-center" id="editarModalTitle{{$d->id}}">Editar Docente</h5>
						      ...
						      <div class="rounded modal-body fondoformulario">
						        {{--  --}}
						        <form method="POST" action="{{route('actualizardocente',$d->id)}}">
						    	{{ csrf_field() }}
						    	<br>
