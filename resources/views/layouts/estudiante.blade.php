...
<body>
    <div class="container-fluid bg-info banner">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
            ...
            <a class="btn m-lg-2 btn-light btn-block bg-warning" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><strong>{{ __('Cerrar Sesión') }}</strong></a>
